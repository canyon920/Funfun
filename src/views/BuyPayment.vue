...
export default {
  ...
  methods:{
    set(){
      ...
      axios.post("http://127.0.0.1:9090/buyPay/productInfo",setForm)
          .then(res => {
    ...
    async payKakao(){
      ...
      await IMP.request_pay({
        ...
        if(rsp.success){
          ...
          await axios.post("http://127.0.0.1:9090/buyPay/verifyIamport",form)
              .then(async rsp2 => {
                // console.log("#검증성공");
          ...
          await axios.post("http://127.0.0.1:9090/buyPay/failPay",fform)
    ...
    async setAfter(rsp,rsp2){
      if(rsp.paid_amount === rsp2.response.amount){
        ...
        await axios.post("http://127.0.0.1:9090/buyPay/successPay",sform)
            .then(rsp3 => {
    ...
    async setPay(){
      ...
      await axios.post("http://127.0.0.1:9090/buyPay/setPay",form)
          .then(rsp => {
